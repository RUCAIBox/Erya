...
from textbox.data.translate_dataset import TranslateDataset, TranslateCollate
from textbox.data.denoising_dataset_bi import DenoisingCollate_BI
from textbox.data.translate_dataset_bi import TranslateCollate_BI
from textbox.data.mono_dataset import MonoCollate
from textbox.data.para_dataset import ParaCollate

from accelerate.logging import get_logger

collate_options = {'mono': MonoCollate, 'para':ParaCollate, 'disabled': AbstractCollate, 'denoising': DenoisingCollate, 'denoising_bi': DenoisingCollate_BI, 'unilm': UnilmCollate, 'translate': TranslateCollate, 'translate_bi': TranslateCollate_BI}
...
def data_preparation(config, tokenizer):
    ...
    dataloaders = []
    if config['do_train']:
        if collate_name=='translate' or collate_name=='translate_bi' or collate_name=='para':
